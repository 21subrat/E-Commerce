    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
          ...
          <div className='flex flex-col overflow-x-auto sm:overflow-y-scroll justify-between sm:justify-normal sm:w-[18.7%] w-full'>
              {
                productData.image.map((item,index)=>(
                  <img onClick={()=>setImage(item)} src={item} key={index} className='w-[24%] sm:w-full h-10 mb-3 sm:h-27.5 object-cover cursor-pointer flex-shrink-0' alt="" />
                ))
              }
          </div>
          <div className='w-full sm:w-80%'>
            <img className='w-full h-119' src={image} alt="" />
        ...
        <div className='flex-1 '>
            ...
            <hr className='mt-8 w-4/5 text-gray-300' />
            <div className='text-sm text-gray-500 mt-5 flex flex-col gap-1'>
              <p>100% Original product</p>
              <p>Casg on delivery is available.</p>
